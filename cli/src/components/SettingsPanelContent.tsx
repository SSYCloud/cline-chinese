...
const FEATURE_SETTINGS = {
	subagents: {
		...
		default: false,
		label: "子 agents",
		description: "让 Cline 并行运行多个专注的子代理来为你探索代码库。",
	},
	autoCondense: {
