...
title: "Agent"
sidebarTitle: "Agent"
description: "API reference for Agent / AgentRuntime from @coohu/agents."
---

`Agent` is an alias for `AgentRuntime` from `@coohu/agents`.

```typescript
import { Agent, AgentRuntime, createAgent, createAgentRuntime } from "@coohu/sdk"
```
