...
<Tabs>
  <Tab title="Adding Members">
    ...
    <Tip>
    **Bulk Invitations:** Need to add multiple users? Contact support@coohu.bot for assistance with bulk invite CSV imports.
    </Tip>
  </Tab>
...
<AccordionGroup>
  ...
  <Accordion title="Can't Remove an Admin" icon="user-slash">
    ...
    **Solution:** Ask an Owner to perform the removal, or if you need to remove your organization's sole Owner, contact support@coohu.bot.
  </Accordion>
