...
5.  **(Optional) Custom Base URL:** If you need to use a custom base URL for the OpenRouter API, check "使用自定义 URL" and enter the URL. Leave this blank for most users.
