...
5.  **(Optional) Custom Base URL:** If you need to use a custom base URL for the Anthropic API, check "使用自定义 URL" and enter the URL. Most users won't need to adjust this setting.
