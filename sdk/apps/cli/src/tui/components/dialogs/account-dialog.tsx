...
import type { ClineAccountOrganization } from "@coohu/core";
...
export function AccountDialogContent(
	...
	if (state.status === "unauthenticated") {
		return (
			<box flexDirection="column" paddingX={1} gap={1}>
				...
				<text fg="gray">↑/↓ 导航，Enter 选择，Esc 退出</text>
			</box>
		);
	}
	...
	return (
		<box flexDirection="column" paddingX={1} gap={1}>
			...
			<text fg="gray">↑/↓ 导航，按 Enter 键选择，按 Esc 键关闭</text>
		</box>
	);
}
