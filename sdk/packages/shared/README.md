...
`@coohu/shared` owns shared cross-package primitives (session common types/utilities).
...
(`@coohu/cli`, `@coohu/code`) so request/response contracts are not duplicated
