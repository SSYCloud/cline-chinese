export declare function formatFileContentBlock(
	path: string,
	content: string,
): string;
export declare function formatUserInputBlock(
	input: string,
	mode?: "act" | "plan" | "yolo",
): string;
export declare function formatUserCommandBlock(
	input: string,
	slash: string,
): string;
...
export declare function parseUserCommandEnvelope(
	input?: string,
