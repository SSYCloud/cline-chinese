...
export declare const TEAM_TASK_IGNORED_FIELDS_BY_ACTION: Partial<
...
export declare const TeamFinalizeOutcomeInputSchema: z.ZodObject<
	...
	z.core.$strip
>;
export declare const TeamListOutcomesInputSchema: z.ZodObject<
	{},
	z.core.$strip
>;
...
export declare const TeamTaskListItemToolResultSchema: z.ZodObject<
	...
	z.core.$strip
>;
export declare const TeamTaskToolResultSchema: z.ZodDiscriminatedUnion<
	[
		z.ZodObject<
			{
