...
export declare const AgentConfigSchema: z.ZodObject<
	{
		...
		tools: z.ZodArray<
			z.ZodCustom<AgentTool<unknown, unknown>, AgentTool<unknown, unknown>>
		>;
		...
		userFileContentLoader: z.ZodOptional<
			z.ZodFunction<
				z.core.$ZodTuple<readonly [z.ZodString], z.core.$ZodFunctionOut>,
				z.ZodPromise<z.ZodString>
			>
		>;
		...
		onEvent: z.ZodOptional<
			z.ZodFunction<
				z.core.$ZodTuple<
					readonly [z.ZodCustom<AgentEvent, AgentEvent>],
		...
		>;
		hooks: z.ZodOptional<
			z.ZodCustom<Partial<AgentRuntimeHooks>, Partial<AgentRuntimeHooks>>
		>;
		parentAgentId: z.ZodOptional<z.ZodString>;
		extensions: z.ZodOptional<
			z.ZodArray<z.ZodCustom<AgentExtension, AgentExtension>>
		>;
		hookErrorMode: z.ZodDefault<
			z.ZodEnum<{
				ignore: "ignore";
				throw: "throw";
			}>
		>;
		toolPolicies: z.ZodOptional<
			z.ZodRecord<
				z.ZodString,
				z.ZodObject<
					{
			...
			>
		>;
		requestToolApproval: z.ZodOptional<
			z.ZodFunction<
				z.core.$ZodTuple<
					readonly [
						z.ZodObject<
			...
			>
		>;
		onConsecutiveMistakeLimitReached: z.ZodOptional<
			z.ZodFunction<
				z.core.$ZodTuple<
					readonly [
						z.ZodObject<
		...
		extensionContext: z.ZodOptional<
			z.ZodCustom<ExtensionContext, ExtensionContext>
		>;
