...
export declare function getDefaultHubCommandTimeoutMs(
	command: HubCommandName,
): number | null;
export declare function resolveHubCommandTimeoutMs(
	command: HubCommandName,
...
export type HubToolExecutorName =
	...
	| "askQuestion"
	| "submit";
export declare const HUB_TOOL_EXECUTOR_NAMES: readonly [
	"readFile",
	"search",
	"bash",
	"webFetch",
...
export declare function isHubToolExecutorName(
	value: unknown,
...
export declare const HUB_USER_INSTRUCTIONS_SNAPSHOT_CAPABILITY =
