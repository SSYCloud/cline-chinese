...
export declare const REMOTE_CONFIG_SESSION_BLOB_UPLOAD_METADATA_KEY =
	"enterprise.blobUpload";
export declare function resolveBlobStoreSettingsFromPromptUploading(
	promptUploading: PromptUploading | undefined,
): RemoteConfigBlobStoreSettings | undefined;
export declare function resolveBlobStoreSettingsFromRemoteConfig(
	remoteConfig: RemoteConfig | undefined,
): RemoteConfigBlobStoreSettings | undefined;
export declare function buildRemoteConfigSessionBlobUploadMetadata(
	remoteConfig: RemoteConfig | undefined,
	userDistinctId?: string,
): RemoteConfigSessionBlobUploadMetadata | undefined;
export declare function registerRemoteConfigSessionBlobUpload(
	sessionId: string,
	remoteConfig: RemoteConfig | undefined,
	userDistinctId?: string,
): RemoteConfigSessionBlobUploadMetadata | undefined;
export declare function clearRemoteConfigSessionBlobUpload(
	sessionId: string,
): void;
export declare function createRemoteConfigBlobStorageAdapter(
	settings: RemoteConfigBlobStoreSettings,
): RemoteConfigBlobStorageAdapter | undefined;
export declare function readRemoteConfigSessionBlobUploadMetadata(
