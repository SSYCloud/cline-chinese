...
export declare function resolveOpenTelemetryConfigFromRemoteConfig(
	remoteConfig: RemoteConfig | undefined,
): Partial<OpenTelemetryClientConfig> | undefined;
export declare function normalizeBundleTelemetry(
	telemetry: Record<string, unknown> | undefined,
): Partial<OpenTelemetryClientConfig> | undefined;
export declare class DefaultRemoteConfigTelemetryAdapter
