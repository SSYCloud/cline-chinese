...
export declare function withRemoteConfigBundlePaths<
	T extends RemoteConfigBundle,
>(bundle: T, paths: RemoteConfigSyncResult["materialized"]["paths"]): T;
...
export declare function prepareRemoteConfigRuntime(
