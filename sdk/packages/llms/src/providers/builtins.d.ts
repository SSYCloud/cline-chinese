import { type GatewayProviderManifest, type GatewayProviderMetadata, type GatewayProviderSettings, type ProviderCapability, type ProviderConfigField } from "@coohu/shared";
...
export type ProviderFamily = "openai" | "openai-compatible" | "anthropic" | "google" | "vertex" | "bedrock" | "mistral" | "claude-code" | "openai-codex" | "opencode" | "dify" | "sap-ai-core";
