import type { SqliteDb } from "@coohu/shared/db";

/**
 * Bootstrap the dedicated cron.db schema. Unlike @coohu/shared's
 * `ensureSessionSchema`, this schema is fully owned by @coohu/core
