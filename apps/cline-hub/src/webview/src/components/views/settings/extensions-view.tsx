...
const sectionDescriptions: Record<CustomizationSection, string> = {
	Rules: "审查决定 Cline 行为的项目级和全局规则文件。",
	Hooks: "检查钩子配置及近期执行状态。",
	MCP: "管理已安装的 MCP 服务器并从市场添加新服务器。",
	Skills: "管理已安装的技能并从市场添加新技能。",
	Agents: "审查从本地设置中发现的已配置代理。",
	Plugins: "管理已安装的插件并从市场添加新插件。",
	Tools: "检查内置工具和由插件贡献的工具。",
};

const sectionCommands: Record<CustomizationSection, string> = {
	Rules: "cline 配置 rules",
	Hooks: "cline 配置 hooks",
	MCP: "cline mcp 安装",
	Skills: "cline skill",
	Agents: "cline 配置 agents",
	Plugins: "cline plugin",
	Tools: "cline 配置 tools",
};
