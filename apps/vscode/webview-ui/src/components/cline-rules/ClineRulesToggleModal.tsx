					...
					<div className="flex-shrink-0 px-3 pt-2">
						...
						<div className="text-xs text-description mb-4">
							{currentView === "rules" ? (
								...
								<p>
									Workflows 允许您定义一系列步骤来引导 Cline 完成重复性任务，例如部署服务或提交 PR。要调用工作流程，请在聊天中输入{" "}
					...
					<div className="flex-1 overflow-y-auto px-3 pb-3" style={{ minHeight: 0 }}>
						{currentView === "rules" ? (
							<>
								...
								{hasRemoteRules && (
									<div className="mb-3">
										<div className="text-sm font-normal mb-2">企业级 Rules</div>
								...
								<div className="mb-3">
									<div className="text-sm font-normal mb-2">全局 Rules</div>
								...
								<div className="-mb-2.5">
									<div className="text-sm font-normal mb-2">工作区 Rules</div>
									<RulesToggleList
										isGlobal={false}
										listGap="small"
										rules={localRules}
							...
							<>
								...
								{hasRemoteWorkflows && (
									<div className="mb-3">
										<div className="text-sm font-normal mb-2">企业级 Workflows</div>
										<div className="flex flex-col gap-0">
								...
								<div className="mb-3">
									<div className="text-sm font-normal mb-2">全局 Workflows</div>
								...
								<div className="-mb-2.5">
									<div className="text-sm font-normal mb-2">工作区 Workflows</div>
									<RulesToggleList
										isGlobal={false}
										listGap="small"
							...
							<>
								<div className="text-xs text-description mb-4">
									<p>
										{isWindows
											? "在 Windows 上，hooks 会在 hook 文件存在时执行。"
											: "切换以启用/禁用 (chmod +x/-x)。"}{" "}
										<VSCodeLink
											className="text-xs"
							...
							<>
								...
								<div className="mb-3">
									<div className="text-sm font-normal mb-2">全局 Skills</div>
									<div className="flex flex-col gap-0">
										{globalSkills
											.filter((s) => !s.path.startsWith("remote:"))
											.sort((a, b) => a.name.localeCompare(b.name))
								...
								<div className="-mb-2.5">
									<div className="text-sm font-normal mb-2">工作区 Skills</div>
									<div className="flex flex-col gap-0">
										{localSkills
											.sort((a, b) => a.name.localeCompare(b.name))
											.map((skill) => (
