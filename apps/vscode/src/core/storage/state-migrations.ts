...
export async function migrateCustomInstructionsToGlobalRules(context: vscode.ExtensionContext) {
	try {
		...
		if (customInstructions?.trim()) {
			Logger.log("Migrating custom instructions to global Cline Chinese rules...")
			...
			Logger.log("Successfully migrated custom instructions to global Cline Chinese rules")
		}
	} catch (error) {
